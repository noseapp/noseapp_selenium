...
def _error_handler(e, driver, query):
    """
    Обработчик ошибок при выполнении запросов

    :param e: инстанс исключения
    :param driver: инстанс WebDriver или WebElement
    :param query: сткрока запроса
    """
